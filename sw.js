...
const PRECACHE_ASSETS = [
  ...
  ...Array.from({ length: 24 }, (_, i) => `./images/photo_aac/routine_full_${String(i + 1).padStart(2, '0')}.jpg`),
  ...Array.from({ length: 16 }, (_, i) => `./images/photo_aac/routine_new_${String(i + 1).padStart(2, '0')}.jpg`),
