...
function photoAacItem(prefix, index, label) {
  ...
  const routineReplacement = {
    ...
    8: "routine_ai_08_photo_identity.jpg",
...
const PHOTO_AAC_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "엘리베이터 1층 누르기", speech: "엘리베이터 1층 누르기", image: "./images/photo_aac/routine_ai_elevator_1_badge.jpg", imageFit: "contain" },
      ...
      { label: "거품목욕하기", speech: "거품목욕하기", image: "./images/photo_aac/routine_ai_bubblebath_bodywash_identity.jpg", imageFit: "contain" },
...
const DATA = {
  ...
  screens: {
    ...
    mealRice: {
      ...
      hero: [],
      items: [
        { label: "밥",       image: "./images/meal_bowl_v2.png" },
    ...
    mealVegetable: {
      ...
      items: [
        ...
        { label: "당근",     image: "./images/mart_items/carrot_real_v3.png", imageFit: "contain" },
    ...
    outingPlace: {
      ...
      items: [
        ...
        { label: "카페",                      image: "./images/places/cafe_with_dad.png", imageFit: "cover" },
